...
.qcf-style'.$id.' div.qcf-slideroutput{font-size:'.$style['output-size'].';color:'.$style['output-colour'].';}';   
        ...
        if (is_admin() && $style['font'] == 'plugin' && ($style['font-family'] || $style['font-family'] != 'inherit')) $fontoutput .= '<link href="https://fonts.googleapis.com/css?family='.$style['font-family'].'" rel="stylesheet" type="text/css">';
    }
    $output = $fontoutput.$code;
    return $output;
}
